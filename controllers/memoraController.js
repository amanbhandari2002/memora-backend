...
const generateCaption = async (filePath, fileName) => {
    try {
        ...
        const response = await axios.post(process.env.ML_SERVICE_URL + "/generate-caption", { filePath: signedURL, fileName })
...
const addMemory = async (req, res) => {
    try {
        ...
        description = await generateCaption(req.file.location, req.file.key)
